    ...
    <div class="w-full max-w-md bg-white shadow-md rounded-lg p-6">
        ...
        <form action="{{ route('pegawai.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_pegawai" id="nama_pegawai" class="py-2 px-3 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Nama pegawai" required>
            </div>
            <div class="mb-4">
